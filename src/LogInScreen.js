        ...
        <div id='input-div'>
          ...
          <div id='email-outer-box'>
            ...
            <div id='email-id-div'>
              ...
              <input type='text' id='input-email' placeholder='joe@gmail.com'></input>
            </div>
          </div>
          ...
          <div id='phone-outer-box'>
            ...
            <div id='phone-id-div'>
              ...
              <input type='text' id='input-phone' placeholder='+91 98256 XXXXX'></input>
            </div>
          </div>
          ...
          <button id='try-luck' onClick={()=> {this.props.changeGameMode('SpinWheelScreen')}}>Try your luck</button>
          <div id='terms'>
